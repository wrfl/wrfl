...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { album_id: @play.album_id, played_at: @play.played_at, track_id: @play.track_id, user_id: @play.user_id }
    end
  ...
  test "should update play" do
    patch :update, id: @play, play: { album_id: @play.album_id, played_at: @play.played_at, track_id: @play.track_id, user_id: @play.user_id }
    assert_redirected_to play_path(assigns(:play))
  end
